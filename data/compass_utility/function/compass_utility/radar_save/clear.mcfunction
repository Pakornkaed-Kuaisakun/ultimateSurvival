...
execute if data block ~ ~ ~ Items[0].components."minecraft:custom_data".est unless data block ~ ~ ~ Items[0].components."minecraft:custom_data".mwt.ow unless data block ~ ~ ~ Items[0].components."minecraft:custom_data".mwt.nt unless data block ~ ~ ~ Items[0].components."minecraft:custom_data".mwt.te run data remove block ~ ~ ~ Items[0].components."minecraft:custom_data".est
