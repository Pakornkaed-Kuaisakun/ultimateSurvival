...
execute unless score @s mwt.sneak.sec matches 1.. if score @s mwt.swap.sec matches 10.. run function compass_utility:compass_utility/radar_save/overworld/radar
